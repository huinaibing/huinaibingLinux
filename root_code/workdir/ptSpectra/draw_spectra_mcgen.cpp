...
void draw_spectra_mcgen()
{
    TFile *file = TFile::Open("/home/huinaibing/Documents/datas4o2/AnalysisResults.root");
    TH2D *hPtCent = file->Get<TDirectory>("pid-flow-pt-corr")->Get<TDirectory>("correction")->Get<TH2D>("hPtCentMcGen");
    TH1D *hCentEventCountData = file->Get<TDirectory>("pid-flow-pt-corr")->Get<TDirectory>("ptSpectra")->Get<TH1D>("hCentEventCountMcGen");
